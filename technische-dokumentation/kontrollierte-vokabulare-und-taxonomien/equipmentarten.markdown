...
Die Equipmentart „Monitor“ ist in dieser Liste nicht vorhanden, da hierzu noch keine Metadaten hinterlegt waren. Sie ist aber in der vollständigen [Datenmodell-Tabelle](/technische-dokumentation/datenmodell.html#tabelle) zu finden.</sub>
